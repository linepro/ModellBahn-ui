...
class Select
{
    ...
    */
	constructor(old)
	{
        ...
        if(!this.placeholder) {
            this.placeholder = this.multiple ? translate("MULTI_SELECT") : translate("SINGLE_SELECT");
        }
    ...
    doSearch(key)
    {
        ...
        if(this.shown.length == 0)
        {
            ...
            item.innerHTML = translate("NO_RESULT");
    ...
    init()
    {
        ...
        if(this.hasSearch)
        {
            ...
            search.setAttribute("aria-label", translate("SEARCH"));
