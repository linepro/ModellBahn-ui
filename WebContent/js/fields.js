...
const ACHSFOLG_DROP = new DropDown(apiUrl("achsfolg"), optionExtractor, bezeichnungOption)
const ADRESS_TYP_DROP = new DropDown(apiUrl("enums/adressTyp"), optionExtractor, bezeichnungOption)
const ANDERUNGS_TYP_DROP = new DropDown(apiUrl("enums/anderungsTyp"), optionExtractor, bezeichnungOption)
const ANTRIEB_DROP = new DropDown(apiUrl("antrieb"), optionExtractor, bezeichnungOption)
const ARTIKEL_DROP = new DropDown(apiUrl("artikel"), optionExtractor, artikelOption)
const AUFBAU_DROP = new DropDown(apiUrl("aufbau"), optionExtractor, bezeichnungOption)
const BAHNVERWALTUNG_DROP = new DropDown(apiUrl("bahnverwaltung"), optionExtractor, bezeichnungOption)
const DECODER_DROP = new DropDown(apiUrl("decoder"), optionExtractor, decoderOption)
const DECODER_STATUS_DROP = new DropDown(apiUrl("enums/decoderStatus"), optionExtractor, decoderOption)
const DECODER_TYP_DROP = new DropDown(apiUrl("decoderTyp"), optionExtractor, produktOption)
const EPOCH_DROP = new DropDown(apiUrl("epoch"), optionExtractor, bezeichnungOption)
const GATTUNG_DROP = new DropDown(apiUrl("gattung"), optionExtractor, bezeichnungOption)
const HERSTELLER_DROP = new DropDown(apiUrl("hersteller"), optionExtractor, bezeichnungOption)
const KONFIGURATION_DROP = new DropDown(apiUrl("enums/konfiguration"), optionExtractor, bezeichnungOption)
const KUPPLUNG_DROP = new DropDown(apiUrl("kupplung"), optionExtractor, bezeichnungOption)
const LAND_DROP = new DropDown(apiUrl("enums/land"), optionExtractor, bezeichnungOption)
const LEISTUNGSUBERTRAGUNG_DROP = new DropDown(apiUrl("enums/leistungsubertragung"), optionExtractor, bezeichnungOption)
const LICHT_DROP = new DropDown(apiUrl("licht"), optionExtractor, bezeichnungOption)
const MASSSTAB_DROP = new DropDown(apiUrl("massstab"), optionExtractor, bezeichnungOption)
const MOTOR_TYP_DROP = new DropDown(apiUrl("motorTyp"), optionExtractor, bezeichnungOption)
const PRODUKT_DROP = new DropDown(apiUrl("produkt"), optionExtractor, produktOption)
const PROTOKOLL_DROP = new DropDown(apiUrl("protokoll"), optionExtractor, bezeichnungOption)
const SONDERMODELL_DROP = new DropDown(apiUrl("sondermodell"), optionExtractor, bezeichnungOption)
const SPURWEITE_DROP = new DropDown(apiUrl("spurweite"), optionExtractor, bezeichnungOption)
const STATUS_DROP = new DropDown(apiUrl("enums/status"), optionExtractor, bezeichnungOption)
const STECKER_DROP = new DropDown(apiUrl("enums/stecker"), optionExtractor, bezeichnungOption)
const STEUERUNG_DROP = new DropDown(apiUrl("steuerung"), optionExtractor, bezeichnungOption)
const UNTER_KATEGORIE_DROP = new DropDown(apiUrl("unterKategorien"), unterKategorieExtractor, kategorieOption)
const VORBILD_DROP = new DropDown(apiUrl("vorbild"), optionExtractor, vorbildOption)
const WAHRUNG_DROP = new DropDown(apiUrl("enums/wahrung"), optionExtractor, bezeichnungOption)
const ZUG_TYP_DROP = new DropDown(apiUrl("zugTyp"), optionExtractor, bezeichnungOption)
